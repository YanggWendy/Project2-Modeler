...
{ 
	...
	MOUTH_R, MOUTH_G, MOUTH_B, LEG_R, LEG_G, LEG_B, EYEBROW_R, EYEBROW_G, EYEBROW_B, LEVEL, TURNONLIGHT, LIGHTX, LIGHTY,
	LIGHTZ, FRAME_ALL, CAM_XPOS, CAM_YPOS, CAM_ZPOS, MODE_ON, MODE, NUMCONTROLS
};
